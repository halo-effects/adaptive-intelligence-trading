        ...
        return {
            ...
            'coins': {
                self.symbol: {
                    ...
                    'tp_type': 'trailing' if eng.cfg.TRAILING_STOP_ENABLED else 'limit',
                    'tp_activation_price': (eng.long_tp if eng.long_tp > 0 else (eng.short_tp if eng.short_tp > 0 else None)) if eng.cfg.TRAILING_STOP_ENABLED else None,
                    'trailing_callback_pct': eng.cfg.TRAILING_CALLBACK_PCT if eng.cfg.TRAILING_STOP_ENABLED else None,
