...
# ΓöÇΓöÇ Trailing Stop TP ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
# ΓöÇΓöÇ Unified production profile ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
# ΓöÇΓöÇ Telegram ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
# ΓöÇΓöÇ Trade Tracker ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
# ΓöÇΓöÇ Exchange Client Wrapper ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
# ΓöÇΓöÇ Coin State ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
class V14PortfolioLiveAster:
    ...
    # ΓöÇΓöÇ State persistence ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ Exchange-as-truth position sync ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ Capital Ledger & Deposit/Withdrawal Detection (Upgrade 1) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    def _detect_capital_change(self):
        ...
        if tx_type == "withdrawal" and (self._tracked_capital - tx_amount) < total_invested:
            ...
            send_telegram(
                f"ΓÜá∩╕Å {TG_PREFIX} <b>Balance drift: -{drift_pct:.1f}%</b>\n"
        ...
        emoji = "\U0001f4e5" if tx_type == "deposit" else "\U0001f4e4"  # ≡ƒôÑ / ≡ƒôñ
        send_telegram(
    ...
    # ΓöÇΓöÇ Per-Coin Regime Flagging (Upgrade 3) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    def _clear_matching_regime_flags(self, new_direction: str):
        ...
        for sym, cs in self.coins.items():
            if cs.regime_flagged:
                # TOP flag + new direction SHORT = match ΓåÆ unflag
                # BOTTOM flag + new direction LONG = match ΓåÆ unflag
                should_clear = (
    ...
    # ΓöÇΓöÇ Funding rate tracking ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ TP order management ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
                ...
                if exchange_entry and exchange_entry > 0:
                    ...
                    if abs(exchange_tp - tp_price) > 0.0001:
                        logger.info(
                            ...
                            f"ΓåÆ TP ${exchange_tp:.6f} (engine had ${tp_price:.6f})"
                        )
        ...
        if TRAILING_STOP_ENABLED:
            ...
            if oid:
                ...
                if oid:
                    ...
                    send_telegram(
                        f"ΓÜá∩╕Å {TG_PREFIX} TP order placement FAILED for {sym}\n"
    ...
    def _check_tp_fills(self):
        """Poll exchange for TP order fills and detect cancelled/expired orders."""
        for sym, cs in list(self.coins.items()):
            ...
            try:
                ...
                if result.get("filled"):
                    ...
                    # TP order was cancelled externally (manual or exchange) — re-place
                    logger.warning(
                        f"TP order {cs.tp_order_id} for {sym} was {result['status']} "
                        f"(detected during live polling). Re-placing TP order."
                    )
                    cs.tp_order_id = None
                    cs.tp_limit_price = None
                    cs.tp_activation_price = None
                    send_telegram(
                        ...
                        f"Re-placing {'trailing stop' if TRAILING_STOP_ENABLED else 'limit'} TP order..."
                    )
    ...
    def _recover_tp_orders(self):
        ...
        3. For each coin:
           - Has position + open sell ΓåÆ adopt order as TP
           - Has position + no order ΓåÆ place new TP
           - No position + stale order ΓåÆ cancel it
        """
        ...
        for sym, cs in list(self.coins.items()):
            ...
            try:
                ...
                if result.get("filled"):
                    ...
                    cs.tp_limit_price = None
                    send_telegram(
                        f"ΓÜá∩╕Å {TG_PREFIX} TP order for {sym} was {result['status']} "
        ...
        for sym, cs in list(self.coins.items()):
            ...
            try:
                ...
                if limit_sells and not cs.tp_order_id:
                    if has_position:
                        # Orphan sell order found + position open ΓåÆ adopt it
                        ...
                        send_telegram(
                            f"≡ƒöº {TG_PREFIX} Orphan TP order adopted for {sym}\n"
                        ...
                        # No position but stale sell orders ΓåÆ cancel all
                        ...
                        send_telegram(
                            f"≡ƒöº {TG_PREFIX} Cancelled {len(limit_sells)} stale order(s) "
                            f"for {sym} (no open position)"
                        )

                elif has_position and not cs.tp_order_id and not limit_sells:
                    # Position open but no TP order anywhere ΓåÆ place one
    ...
    def _handle_tp_fill(self, sym: str, cs: CoinState, fill_result: dict):
        ...
        if record:
            ...
            if cs.tp_type == "trailing" and cs.tp_activation_price and actual_price > cs.tp_activation_price:
                ...
                trail_bonus_str = f"\n≡ƒÄ» Trail bonus: +${trail_bonus:.2f} above fixed TP"
            ...
            send_telegram(
                ...
                f"Symbol: {sym}\n"
                f"Fill: ${actual_price:.6f} ├ù {actual_qty:.4f} = ${actual_proceeds:.2f}\n"
    ...
    # ΓöÇΓöÇ Candle processing ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ Action execution ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        if act_type == "BUY":
            ...
            if exchange_balance < cost * 1.01:
                ...
                if now - last_alert > 3600:
                    ...
                    send_telegram(
                        f"ΓÜá∩╕Å {TG_PREFIX} BUY skipped - insufficient USDT\n"
            ...
            if result and result.get("status") in ("filled", "dry_run"):
                ...
                if spread_bps > 50:  # > 0.5%
                    send_telegram(
                        f"ΓÜá∩╕Å {TG_PREFIX} High spread on {sym} BUY: {spread_bps:.0f}bps\n"
                ...
                send_telegram(
                    f"≡ƒö╡ {TG_PREFIX} <b>DCA Layer {layer}</b>\n"
                    f"Symbol: {sym}\n"
                    f"Fill: ${actual_price:.6f} ├ù {actual_qty:.4f} = ${actual_cost:.2f}\n"
            ...
            if result and result.get("status") in ("filled", "dry_run"):
                ...
                send_telegram(
                    f"ΓÜá∩╕Å {TG_PREFIX} <b>SELL FAILED</b>\n"
    ...
    # ΓöÇΓöÇ Capital Router integration ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
            ...
            for sym, alloc in allocations.items():
                if sym not in self.coins:
                    if self.bot_state != BotState.RUNNING:
                        logger.info(f"Skipping new coin {sym} ΓÇö bot state is {self.bot_state}")
                        continue
                    # Gate: don't exceed tier coin cap with new engines
                    if tier_cap > 0 and active_count >= tier_cap:
                        logger.info(
                            f"Skipping new coin {sym} ΓÇö at tier cap "
                    ...
                    # Force warmup for live trading ΓÇö weΓÇÖre trading against real
    ...
    # ΓöÇΓöÇ Portfolio Regime Monitor ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    def _evaluate_regime(self, current_dt: datetime):
        ...
        try:
            ...
            if should_alert or self._regime_alert_state == "AWAITING_APPROVAL":
                tier_emoji = {"EARLY": "≡ƒƒí", "STRONG": "≡ƒƒá", "MAJORITY": "≡ƒö┤"}.get(current_tier, "ΓÜá∩╕Å")
                ...
                if self._regime_alert_state != "AWAITING_APPROVAL":
                    ...
                    msg += f"\n\nΓÅ│ Still awaiting your decision. ({signal_count}/{total} coins signaling)"
    ...
    # ΓöÇΓöÇ Wind-down ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    def _check_wind_down_complete(self):
        ...
        send_telegram(
            f"Γ£à {TG_PREFIX} <b>Wind-Down Complete</b>\n"
            f"All positions closed.\n"
            f"Ready for direction flip."
            f"\n\nΓÜá∩╕Å Direction flip logic not yet implemented - "
    ...
    # ΓöÇΓöÇ Telegram commands ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    def _handle_command(self, text: str):
        ...
        if text == "APPROVE":
            if self._regime_alert_state != "AWAITING_APPROVAL":
                send_telegram(f"i∩╕Å {TG_PREFIX} No pending regime change to approve.")
                return
            self.bot_state = BotState.WIND_DOWN
            self._regime_alert_state = "NONE"
            send_telegram(
                f"ΓÅ│ {TG_PREFIX} <b>Wind-Down Started</b>\n"
            ...
            if self._regime_alert_state != "AWAITING_APPROVAL":
                send_telegram(f"i∩╕Å {TG_PREFIX} No pending regime change to deny.")
                return
            self._regime_alert_state = "NONE"
            self._regime_signal_count = 0
            send_telegram(
                f"Γ£à {TG_PREFIX} Regime change denied. Continuing current strategy."
            )
            ...
            if self.bot_state == BotState.PAUSED:
                send_telegram(f"i∩╕Å {TG_PREFIX} Already paused.")
                return
            self.bot_state = BotState.PAUSED
            send_telegram(
                f"ΓÅ╕∩╕Å {TG_PREFIX} <b>Trading Paused (Global)</b>\n"
            ...
            if not target:
                send_telegram(
                    f"Γ¥ô {TG_PREFIX} Symbol '{coin_name}' not found.\n"
                    f"Active: {', '.join(s.split('/')[0] for s in self.coins)}"
                )
                return
            cs = self.coins[target]
            if cs.paused:
                send_telegram(f"i∩╕Å {TG_PREFIX} {coin_name} is already paused.")
                return
            cs.paused = True
            send_telegram(
                f"ΓÅ╕∩╕Å {TG_PREFIX} <b>{coin_name} Paused</b>\n"
            ...
            if self.bot_state != BotState.PAUSED:
                send_telegram(f"i∩╕Å {TG_PREFIX} Not currently paused.")
                return
            self.bot_state = BotState.RUNNING
            ...
            send_telegram(
                f"Γû╢∩╕Å {TG_PREFIX} <b>Trading Resumed (Global)</b>\n"
            ...
            if not cs.paused and not cs.regime_flagged:
                send_telegram(f"i∩╕Å {TG_PREFIX} {coin_name} is not paused or flagged.")
                return
            ...
            send_telegram(
                f"Γû╢∩╕Å {TG_PREFIX} <b>{coin_name} Resumed</b>\n"
            ...
            if coin_name == "ALL":
                ...
                if target:
                    ...
                    send_telegram(
                        f"Γ¥ô {TG_PREFIX} Symbol '{coin_name}' not found in active positions.\n"
                        f"Active: {', '.join(s.split('/')[0] for s in self.coins)}"
                    )
            ...
            parts = text.split(None, 1)
            if len(parts) < 2:
                send_telegram(f"i∩╕Å {TG_PREFIX} Usage: DEPOSIT <amount>")
                return
            try:
                amount = float(parts[1].strip())
            except ValueError:
                send_telegram(f"Γ¥î {TG_PREFIX} Invalid amount: '{parts[1].strip()}'")
                return
            if amount <= 0:
                send_telegram(f"Γ¥î {TG_PREFIX} Amount must be positive.")
                return
            old_capital = self._tracked_capital
            record_ledger_transaction(
            ...
            parts = text.split(None, 1)
            if len(parts) < 2:
                send_telegram(f"i∩╕Å {TG_PREFIX} Usage: WITHDRAW <amount>")
                return
            try:
                amount = float(parts[1].strip())
            except ValueError:
            ...
            if (self._tracked_capital - amount) < total_invested:
                send_telegram(
                    f"Γ¥î {TG_PREFIX} Cannot withdraw ${amount:.2f}\n"
                    f"Tracked capital: ${self._tracked_capital:.2f}\n"
    ...
    def _force_close_coin(self, sym: str):
        ...
        if not cs or not cs.engine or not cs.engine._engine:
            send_telegram(f"Γ¥ô {TG_PREFIX} No open position for {sym}")
            return
        ...
        send_telegram(f"≡ƒöä {TG_PREFIX} Force-closing {sym} at market...")
        ...
        if result and result.get("status") in ("filled", "dry_run"):
            ...
            send_telegram(f"Γ¥î {TG_PREFIX} Force-close failed for {sym}. Check logs.")
    ...
    def _force_close_all(self):
        ...
        if not open_syms:
            send_telegram(f"i∩╕Å {TG_PREFIX} No open positions to close.")
            return
        send_telegram(f"≡ƒöä {TG_PREFIX} Force-closing {len(open_syms)} positions...")
        for sym in open_syms:
            self._force_close_coin(sym)

    # ΓöÇΓöÇ Status ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ CFGI polling ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ Main loop ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    def run(self):
        ...
        # ΓöÇΓöÇ Exclusive file lock (prevents duplicate instances) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        try:
            ...
            send_telegram(
                f"≡ƒÜÇ {TG_PREFIX} <b>Live Bot Started</b>\n"
            ...
            # ΓöÇΓöÇ Main loop ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
                ...
                try:
                    ...
                    for sym, cs in list(self.coins.items()):
                        ...
                        if current_phase != prev_phase and prev_phase is not None:
                            if cs.tp_order_id:
                                logger.info(
                                    f"Phase change {prev_phase} ΓåÆ {current_phase}: "
