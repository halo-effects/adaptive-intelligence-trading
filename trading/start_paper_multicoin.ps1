# Multi-Coin Paper Trading Bot Launcher
...
Write-Host "Starting Multi-Coin Paper Trading Bot... API Key: $($env:ASTER_API_KEY.Substring(0,8))..." -ForegroundColor Green

Set-Location C:\Users\Never\.openclaw\workspace
& C:\Users\Never\AppData\Local\Programs\Python\Python312\python.exe -m trading.run_paper_multicoin --capital 10000 --profile medium --max-coins 3