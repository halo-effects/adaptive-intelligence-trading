...
_Version: 1.5 | Date: 2026-05-06 | Status: Cloud-Ready_
...
_Updated: 2026-05-06 (v1.5 — Restored v14_capital_manager.py from sync corruption. Fixed T1 gate/rebalance active_allocations desync. Fixed liquidity filter crash. Fixed dashboard sync source file deletion. Fixed dashboard data source.)_
