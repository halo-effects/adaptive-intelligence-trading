...
Safety Order multiplier: 1.5x volume per layer (capped at layer 4)
Max layers:      4 (was 12 before 2026-05-12; layers 5-12 never fired)
Take Profit:     3.0% above average entry (was 1.5% before 2026-05-12)
...
```python
DCA_TP_PCT          = 0.015   # 1.5% take profit (base default; high profile overrides to 0.030)
...
| 3.0% TP for high profile (was 1.5%) | Portfolio-level backtest (2026-05-12) showed +26.3% PnL with 3.0% TP. Higher return per deal outweighs fewer deals. Low/medium profiles remain at 1.5% TP. See `specs/grid-optimization-tp3-4layer.md` |
