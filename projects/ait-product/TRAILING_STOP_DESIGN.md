...
_Created: 2026-04-13 | Status: DRAFT_
...
1. After BUY → place a **TRAILING_STOP_MARKET** order with:
   ...
   - `callbackRate` = 0.5% (trail distance)
...
**Zero-downside guarantee:** Since the trail only activates at +1.5% (our current TP level), worst case is identical to today. Best case captures runaway moves (avg peak was 3.68% in backtest).
