...
declare class FactoryModule {
    ...
    /**
     * Fetches the current fee to create a token and creates one.
     */
    createToken(symbol: string, name: string, hybridMultiplier: bigint, frozen: boolean, usdbForBonding: bigint, startLP: bigint, autoVest: boolean, autoVestDuration: bigint, gradualAutovest: boolean): Promise<{
        hash: `0x${string}`;
...
declare class PredictionMarketsModule {
     ...
     */
    createMarket(marketName: string, symbol: string, endTime: bigint, optionNames: string[], maintoken: Address, frozen: boolean, bonding: bigint, seedAmount?: bigint): Promise<{
        hash: `0x${string}`;
        receipt: viem.TransactionReceipt;
    }>;
    /**
