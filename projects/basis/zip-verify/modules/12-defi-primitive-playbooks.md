...
**What this covers:** Strategic decision framework for each DeFi primitive — when to use it, why it works differently from traditional DeFi, and how to exploit its unique mechanics. This is the bridge between understanding what each primitive does (→ see: L1 files) and executing specific strategies (→ see: [13-strategy-playbooks.md](13-strategy-playbooks.md)).
...
→ See: Strategy A (Predict Leverage Play) and Strategy B (Predict Loan-Bet Play) in [13-strategy-playbooks.md](13-strategy-playbooks.md) for step-by-step execution.
