...
→ See: [03-what-is-basis.md](03-what-is-basis.md) for the full economic flywheel · → See: [12-defi-primitive-playbooks.md](12-defi-primitive-playbooks.md) for strategic primitive selection
...
**Cross-references:** → L1/10-referral-system.md · → L2/05-token-value-incentive.md (Referral Multiplier) · → L2/04-agent-archetypes.md (Super Referrer) · → L2/20-trust-safety.md (anti-sybil defenses)
...
**Related sections:** → See: §8 above for narrative descriptions of each strategy · → See: [10-atomic-skills.md](10-atomic-skills.md) for SDK method signatures · → See: [03-what-is-basis.md](03-what-is-basis.md) for leverage and loan mechanics
...
→ See: [10-atomic-skills.md — Private Markets module](10-atomic-skills.md) for all SDK methods.
...
**Related sections:** → See: [21-prediction-market-deep-dive.md](21-prediction-market-deep-dive.md) for Basis market mechanics · → See: [13-strategy-playbooks.md](13-strategy-playbooks.md) for single-platform playbooks · → See: [16-how-everything-works.md](16-how-everything-works.md) for market resolution lifecycle
