...
**Cross-refs:** → [05-agent-archetypes](modules/05-agent-archetypes.md) · → [12-how-everything-works](modules/12-how-everything-works.md) · → [17-fee-cost-reference](modules/17-fee-cost-reference.md)
...
**Cross-refs:** → [22-trust-safety](modules/22-trust-safety.md) · → [06-referral-system](modules/06-referral-system.md) · → [18-offchain-api-reference](modules/18-offchain-api-reference.md)
...
**Cross-refs:** → [24-code-examples](modules/24-code-examples.md) · → [19-mcp-server](modules/19-mcp-server.md)
...
**Cross-refs:** → [10-atomic-skills](modules/10-atomic-skills.md) · → [17-fee-cost-reference](modules/17-fee-cost-reference.md)
...
**Cross-refs:** → [14-strategy-playbooks](modules/14-strategy-playbooks.md) · → [17-fee-cost-reference](modules/17-fee-cost-reference.md)
...
**Cross-refs:** → [10-atomic-skills](modules/10-atomic-skills.md) · → [13-defi-primitive-playbooks](modules/13-defi-primitive-playbooks.md) · → [17-fee-cost-reference](modules/17-fee-cost-reference.md)

---

### 15-prediction-deep-dive.md
...
**Cross-refs:** → [14-strategy-playbooks](modules/14-strategy-playbooks.md) · → [12-how-everything-works](modules/12-how-everything-works.md) · → [17-fee-cost-reference](modules/17-fee-cost-reference.md)

---

### 16-prediction-arb-engine.md
...
**Cross-refs:** → [15-prediction-deep-dive](modules/15-prediction-deep-dive.md) · → [14-strategy-playbooks](modules/14-strategy-playbooks.md)

---

### 17-fee-cost-reference.md
...
**Cross-refs:** → [12-how-everything-works](modules/12-how-everything-works.md) · → [20-what-to-avoid](modules/20-what-to-avoid.md)

---

### 18-offchain-api-reference.md
...
**Cross-refs:** → [10-atomic-skills](modules/10-atomic-skills.md) · → [18-offchain-api-reference](modules/18-offchain-api-reference.md) · → [03-getting-started](modules/03-getting-started.md)
...
**Cross-refs:** → [11-why-each-action-matters](modules/11-why-each-action-matters.md) · → [17-fee-cost-reference](modules/17-fee-cost-reference.md) · → [24-code-examples](modules/24-code-examples.md)
...
**Cross-refs:** → [25-production-operations](modules/25-production-operations.md)
...
**Cross-refs:** → [03-getting-started](modules/03-getting-started.md) · → [21-error-handling](modules/21-error-handling.md) · → [20-what-to-avoid](modules/20-what-to-avoid.md)
