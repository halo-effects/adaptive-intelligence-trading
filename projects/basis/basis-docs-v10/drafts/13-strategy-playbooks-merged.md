...
→ See: [18-fee-cost-reference.md](18-fee-cost-reference.md) for total cost calculations · [22-mistakes-to-avoid.md](22-mistakes-to-avoid.md) for loan pitfalls
...
→ See: [04-agent-archetypes.md — Token Creator](04-agent-archetypes.md) for full playbook
...
→ See: [04-agent-archetypes.md — Super Referrer](04-agent-archetypes.md) for the full playbook · [09-referral-system.md](09-referral-system.md) for tier percentages
