...
**Related sections:** → See: [15-why-each-action-matters.md](15-why-each-action-matters.md) for what TO do and why · → See: [18-fee-cost-reference.md](18-fee-cost-reference.md) for fee details · → See: [16-how-everything-works.md](16-how-everything-works.md) for mechanics behind each system · → See: [25-code-examples.md](25-code-examples.md) for correct usage patterns
