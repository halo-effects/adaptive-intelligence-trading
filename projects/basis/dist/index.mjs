...
import { getContract, getAddress, keccak256, toBytes } from "viem";
var FactoryModule = class {
  ...
  async createTokenWithMetadata(options) {
    ...
    if (tokenCreatedLog && tokenCreatedLog.topics[1]) {
      tokenAddress = getAddress("0x" + tokenCreatedLog.topics[1].slice(26));
    } else {
...
var TradingModule = class {
  ...
  buildBuyPath(tokenAddress) {
    const usdb = getAddress2(this.client.usdbAddress);
    const mainToken = getAddress2(this.client.mainTokenAddress);
    const target = getAddress2(tokenAddress);
    if (target === mainToken) {
...
import { getAddress as getAddress3, keccak256 as keccak2562, toBytes as toBytes2 } from "viem";
var PredictionMarketsModule = class {
  ...
  async createMarketWithMetadata(options) {
    ...
    const MARKET_CREATED_TOPIC = keccak2562(toBytes2("MarketCreated(address,address,address)"));
    ...
    if (marketLog && marketLog.topics[1]) {
      marketTokenAddress = getAddress3("0x" + marketLog.topics[1].slice(26));
    } else {
