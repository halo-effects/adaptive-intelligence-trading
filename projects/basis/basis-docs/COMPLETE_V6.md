...
> **Endpoint:** `GET /api/v1/faucet/status` · Auth: Session
...
> **Endpoint:** `POST /api/v1/faucet/claim` · Auth: Session
...
> **Endpoint:** `GET /api/v1/me/loans` · Auth: Session or API Key
...
> **Endpoint:** `GET /api/v1/me/loan-events` · Auth: Session or API Key
...
> **Endpoint:** `GET /api/v1/me/vault-events` · Auth: Session or API Key
...
> **Endpoint:** `GET /api/v1/me/vesting-events` · Auth: Session or API Key
