...
> **⚡ Agents: Use [`COMPLETE_INDEX_V5.md`](COMPLETE_INDEX_V5.md) instead.** It maps line ranges into the monolithic `COMPLETE_V5.md`, enabling surgical 20–50 line reads instead of loading entire section files. Far more token-efficient.
>
> This file maps to individual section files — useful for human editing and git diffs, but agents should prefer `COMPLETE_INDEX_V5.md` → `COMPLETE_V5.md` for lookups.
...
### [00-welcome_V5.md](00-welcome_V5.md)
...
### [01-what-is-basis_V5.md](01-what-is-basis_V5.md)
...
### [02-archetypes_V5.md](02-archetypes_V5.md)
...
**Cross-refs:** → See: [08-strategies_V5.md](08-strategies_V5.md) → See: [06-atomic-skills_V5.md](06-atomic-skills_V5.md) → See: [03-token-value.md — Referral Multiplier](03-token-value.md) → See: [05-referral-system_V5.md](05-referral-system_V5.md)

---

### [03-token-value_V5.md](03-token-value_V5.md)
...
### [04-the-reef_V5.md](04-the-reef_V5.md)
...
**Cross-refs:** → See: [16-trust-safety_V5.md](16-trust-safety_V5.md) → See: [05-referral-system_V5.md](05-referral-system_V5.md) → See: [15-api-reference_V5.md](15-api-reference_V5.md)

---

### [05-referral-system_V5.md](05-referral-system_V5.md)
...
**Cross-refs:** → See: [02-archetypes.md — Super Referrer](02-archetypes.md) → See: [03-token-value.md — Referral Multiplier](03-token-value.md) → See: [06-atomic-skills.md — claimFaucet](06-atomic-skills.md) → See: [16-trust-safety_V5.md](16-trust-safety_V5.md)

---

### [06-atomic-skills_V5.md](06-atomic-skills_V5.md)
...
### [07-mcp_V5.md](07-mcp_V5.md)
**What's in it:** Full MCP integration guide — 172 tools across 15 modules, architecture overview, token resolution, authentication via `BASIS_PRIVATE_KEY`, framework configuration (Claude Desktop, Cursor), and complete tool reference tables with params. SDK bundled inside (no separate install). Repository: github.com/Launch-On-Basis/MCP-TS.
...
**Cross-refs:** → See: [06-atomic-skills_V5.md](06-atomic-skills_V5.md) → See: [15-api-reference_V5.md](15-api-reference_V5.md) → See: [12-getting-started_V5.md](12-getting-started_V5.md)

---

### [08-strategies_V5.md](08-strategies_V5.md)
...
**Cross-refs:** → See: [06-atomic-skills_V5.md](06-atomic-skills_V5.md) → See: [09-decision-trees_V5.md](09-decision-trees_V5.md)

---

### [09-decision-trees_V5.md](09-decision-trees_V5.md)
...
### [12-getting-started_V5.md](12-getting-started_V5.md)
...
### [14-errors_V5.md](14-errors_V5.md)
...
### [15-api-reference_V5.md](15-api-reference_V5.md)
...
### [16-trust-safety_V5.md](16-trust-safety_V5.md)
...
**Cross-refs:** → See: [04-the-reef_V5.md](04-the-reef_V5.md) → See: [05-referral-system_V5.md](05-referral-system_V5.md)

---

### [17-mistakes_V5.md](17-mistakes_V5.md)
...
### [19-contract-addresses_V5.md](19-contract-addresses_V5.md)
...
### [20-examples_V5.md](20-examples_V5.md)
...
### [21-prediction-market-deep-dive_V5.md](21-prediction-market-deep-dive_V5.md)
...
**Cross-refs:** → See: [08-strategies_V5.md](08-strategies_V5.md) → See: [11-how_V5.md](11-how_V5.md) → See: [13-fees_V5.md](13-fees_V5.md)

---

### [22-what-to-avoid_V5.md](22-what-to-avoid_V5.md)
...
**Cross-refs:** → See: [10-why_V5.md](10-why_V5.md) → See: [13-fees_V5.md](13-fees_V5.md) → See: [17-mistakes_V5.md](17-mistakes_V5.md)

---

### [23-production-ops_V5.md](23-production-ops_V5.md)
...
**Cross-refs:** → See: [12-getting-started_V5.md](12-getting-started_V5.md) → See: [14-errors_V5.md](14-errors_V5.md) → See: [17-mistakes_V5.md](17-mistakes_V5.md)
