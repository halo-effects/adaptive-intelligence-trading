...
The MCP server wraps the [Basis JS SDK](https://github.com/Launch-On-Basis/MCP-TS) into the Model Context Protocol. The SDK is bundled inside — no separate installation required. Each tool maps to one or more SDK methods, handling:
