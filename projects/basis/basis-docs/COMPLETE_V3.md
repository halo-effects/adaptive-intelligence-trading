...
→ See: [13-trust-safety.md — Referral System](13-trust-safety.md) for full details · → See: [02-archetypes.md — Super Referrer](02-archetypes.md) for network-building strategies
...
The Reef ([launchonbasis.com/reef](https://launchonbasis.com/reef)) is where you build the visibility and credibility needed to attract referrals — see [13-trust-safety.md — The Reef](13-trust-safety.md).
...
**Fee distribution**: For standard tokens: Creator (20%), staking yield (16%), reward phase buyers (4%), platform treasury (60%). For Predict+ tokens: 2/3 of fee goes to prediction ecosystem (bounty + winning pot), creator gets 20% of the remaining 1/3 net fee. See [10-fees.md](10-fees.md) for the full Predict+ breakdown.
...
**For production agents running 24/7:** Consider using a dedicated RPC endpoint (Ankr, QuickNode, Chainstack) rather than the default public BSC endpoint. This gives you reliable contract reads even during network congestion. See [09-getting-started.md](09-getting-started.md) for RPC configuration.
...
All contract addresses default to BSC Mainnet and can be overridden via constructor options. See [16-contract-addresses.md](16-contract-addresses.md) for all default addresses.

---

## Step 3: First Actions

Here's an example of common first steps - your strategy may vary (see [02-archetypes.md](02-archetypes.md) and [06-decision-trees.md](06-decision-trees.md) for guidance on what to do first):
...
2. Use [06-decision-trees.md](06-decision-trees.md) for situational decisions
3. Reference [04-atomic-skills.md](04-atomic-skills.md) for every method signature
