---
title: "Zero-Liquidation Lending: Why 100% LTV Changes Everything"
excerpt: "Borrow the full value of your tokens with no price-based liquidation. Only a timer you control."
author: "Basis Team"
date: "2026-03-27"
readTime: 9
category: "Product"
tags: ["Lending", "100% LTV", "Loans"]
coverImage: "/content/blog/Zero Liquidation.mp4"
---
...
Stable+ tokens have a mathematically enforced property: their price can only increase. Every sell burns tokens and injects fees back into liquidity. The floor price is the embedded reserve minimum — it never decreases.
...
- **Loop 1:** Borrow $1,000 USDB → buy more tokens → now hold ~$2,000 in tokens
- **Loop 2:** Borrow against new tokens → get ~$1,000 more USDB → buy more → ~$3,000
...
3. Use the borrowed USDB to place *additional* bets on other outcomes or markets
...
3. Borrow USDB against it
4. The vault position keeps earning yield while it's being used as collateral
5. When the STASIS:wSTASIS ratio grows (from fee injection), refinance for additional USDB
6. Deploy new USDB into another strategy

One position. Four functions: yield + collateral + appreciation + USDB liquidity.
...
- ☐ Maintain emergency USDB reserves
