...
- **Basis**: **SDK + MCP PUBLISHED** (2026-04-04). Phase 1 "Founding Lobster" entering pre-launch. MCP-TS: 172 tools, 15 modules. SDK-TS + Python SDK on GitHub. Docs live at launchonbasis.com (llms.txt, COMPLETE.md, OpenAPI spec, interactive API docs). Airdrop: 11% total supply, 3 phases (1%/2%/8%), floor FDV $150M. Platform sponsors 0.01 BNB gas/wallet/day. Smart contract audit: Sonnet 4.6 as preliminary auditor, methodology from Hashlock public audits. Alex updating SDKs + MCP based on Claude code audit. Beta testers providing feedback before formal Phase 1 launch. GeeGee on beta tester list — standing by. V6 doc files (faucet/transfer warnings) delivered Apr 3. Old basis-defi skill scaffold (v0.3.0) is stale — don't wire until Alex's updates land.
