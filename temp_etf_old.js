...
var PHASE_DESC = {
  LONG_DCA:'Long grid active ΓÇö buying dips, cycling TPs',
  SHORT_DCA:'Short grid active ΓÇö selling rallies, cycling TPs',
  ROUTER:'Evaluating direction ΓÇö waiting for signal confirmation'
};
...
function renderFlowDiagram(){
  ...
  syms.forEach(function(sym){
    ...
    rowData.push({sym:sym,m:m,isActive:isActive,phase:phase,dcaScore:dcaScore,dealsWk:dealsWk,avgCycle:avgCycle,capFree:capFree,ddPct:ddPct});
  });
